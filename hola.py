...
class Software:
    def __init__(self, catalogo_canciones):
        self.catalogo_canciones:str = catalogo_canciones
...
class ListaReproduccion:
    ...
    def agregar_cancion_lista(self,cancion, catalogo_canciones):
        if cancion in catalogo_canciones:
            self.lista_canciones.append(cancion)
        else:
            raise Exception(f"La cancion {cancion.nombre},no se encuentra en el catalogo de canciones.")
...
class Reproductor:
    ...
    def reproducir_cola(self):
        pass #Todas las canciones en la cola recorrer e invocar metodo reproducir canciones 
...
class Usuario:
    ...
    """def mostrar_listas(self):
        for lista_reproduccion in self.lista_reproduccion:
            print(f"Nombre de la lista: {lista_reproduccion.nombre}")
    """
    def mostrar_listas(self):
        for lista_reproduccion in self.lista_reproduccion:
            print(f"Nombre de la lista: {lista_reproduccion.nombre}")
...
#usuario = Usuario("Pepito", "pepito@gmail.com")

#nombre_lista = input("Ingresa el nombre de la lista de reproducción: ")

#usuario.crear_lista_de_reproduccion(nombre_lista)

#usuario.mostrar_listas()
